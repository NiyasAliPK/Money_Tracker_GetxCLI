...
class IncomeCats extends StatelessWidget {
  IncomeCats({Key? key}) : super(key: key);
              ...
              () {
                ...
                return GridView.builder(
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 10,
                      crossAxisSpacing: 50),
                  itemCount: _categoryController.incomeCatsList.length,
                  itemBuilder: (BuildContext context, int index) {
                    final data = _categoryController.incomeCatsList[index];
          ...
          child: Padding(
            ...
            child: Container(
                ...
                child: Obx(() {
                  ...
                  return (_transactionDatabase.selectedCatTrans.isEmpty ||
                          _transactionDatabase.incomeTransactionList.isEmpty)
                      ? Center(
                          child: Lottie.asset(
