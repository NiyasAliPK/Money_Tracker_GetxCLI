...
class ExpenseTabViewAll extends StatelessWidget {
  ...
  ExpenseTabViewAll({Key? key, required this.selectedPeriod}) : super(key: key);
        ...
        return (_transactionDatabase.expenseTransactionList.isEmpty &&
            ...
            : ListView.builder(
                itemCount: selectedPeriod == 'All'
                    ? _transactionDatabase.expenseTransactionList.length
                    : _transactionDatabase.periodSortedlsit.length,
                itemBuilder: (BuildContext context, int index) {
                  final newList = selectedPeriod == 'All'
                      ? _transactionDatabase.expenseTransactionList.reversed
